...
public class BookingController {
    ...
    public String getFlightForBooking(int serialNo,String origin,String dest,String airway,int count){
        HashMap<Integer, String> data;
        data = controllerFlight.getFlightsBymap(origin,dest,airway,count);
